  ...
  <div class="page-sidebar" id="main-menu">
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
      <div class="user-info-wrapper">
        <div class="profile-wrapper"> <img src="userimages/user.png"  alt="" data-src="userimages/user.png" data-src-retina="userimages/user.png" width="69" height="69" /> </div>
        <div class="user-info">
          ...
          <li class=""><a href="change-password.php"><span class="fa fa-file-text-o"></span> Change Password</a></li>
                            <li><a href="profile.php"><span class="fa fa-user"></span> Profile</a></li>
                              ...
                              <li ><a href="get-quote.php"> <span class="fa fa-tasks"></span> Request a Quote</a></li>
                                ...
                                <li ><a href="view-tickets.php"><span class="fa fa-ticket"></span> View Status</a></li>
                           <li ><a href="feedback.php"><span class="fa fa-phone"></span> Feedback Form</a></li>
    </ul>
