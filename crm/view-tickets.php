  ...
  <div class="page-content">
    ...
    <div class="content">
      <ul class="breadcrumb">
        ...
        <li><a href="#" class="active">View Status</a></li>
      </ul>
      <div class="clearfix"></div>
      
      <h4> <span class="semi-bold">Status</span></h4>
      <br>
      <div class="row">
        <div class="col-md-12">
     ...
     <?php $rt=mysqli_query($con,"SELECT * FROM `prostatus` WHERE com_mail='".$_SESSION['login']."'");
     ...
     if($num>0){
		...
		?> 
            ...
            <tr style="padding-top:50%; cell-spacing:50px;">
                  <td class="col-md-4" style="cell-spacing:50px;">
                            Status
                  </td>
                  <td class="col-md-4" style=" cell-spacing:50px;">
                  <?php echo $row['phase'];?>
                  ...
                  <td class="col-md-4" style="cell-spacing:50px;">
                  <?php echo $row['completion_per'];?>
                  </td>
                  <td class="col-md-4" style="padding-top:2%; cell-spacing:50px;">
